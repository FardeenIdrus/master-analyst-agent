    ...
    return rx.box(
        ...
        rx.flex(
            ...
            rx.vstack(
                ...
                _agent_node("Fardeen", "20%", "bar-chart-3", BLUE, "0.2s"),
                _agent_node("Tamer", "30%", "trending-up", BLUE, "0.3s"),
            ...
            rx.vstack(
                ...
                _agent_node("Daria", "15%", "file-search", PURPLE, "0.25s"),
                _agent_node("Shakzod", "15%", "calculator", PURPLE, "0.35s"),
                _agent_node("Lary", "10%", "database", CYAN, "0.45s"),
                _agent_node("Mohamed", "10%", "pie-chart", CYAN, "0.55s"),
                spacing="1", flex="1", width="100%",
                padding="14px", border_radius="16px",
